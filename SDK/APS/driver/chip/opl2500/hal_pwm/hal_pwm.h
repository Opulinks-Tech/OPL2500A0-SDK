...
*  Project:
*  --------
*  OPL2500 Project - the PWM definition file
*
*  Description:
*  ------------
...
#define HAL_PWM_MAX_PERIOD  32767   // 15 bits

#define HAL_PWM_MIN_DUTY    0
#define HAL_PWM_MAX_DUTY    32767   // 15 bits

#define HAL_PWM_MIN_RAMP    0
#define HAL_PWM_MAX_RAMP    32767   // 15 bits
...
typedef struct
{
    ...
    uint32_t ulHoldRgTg;        // the hold times of the ramp up/ramp down per clock cycle
    uint32_t ulHoldRgTg_EN;     // the hold times of the ramp up/ramp down per clock cycle enable
