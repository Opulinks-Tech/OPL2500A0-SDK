...
static T_BleWifi_Ble_MsgHandlerTbl gBleCmMsgHandlerTbl[] =
{
    ...
    {LE_CM_MSG_CONNECTION_COMPLETE_IND,     BleWifi_Ble_CmMsgHandler_ConnectionCompleteInd},
    {LE_CM_MSG_SIG_CONN_UPDATE_REQ,         BleWifi_Ble_CmMsgHandler_SignalUpdateReq},
...
static void BleWifi_Ble_SetScanData(void)
{
    ...
    LeGapSetScanRspData(gTheBle.scn_data.len, gTheBle.scn_data.buf);
...
static void BleWifi_Ble_CmMsgHandler_ConnectionCompleteInd(TASK task, MESSAGEID id, MESSAGE message)
{
    ...
    BLEWIFI_INFO("APP-LE_CM_MSG_CONNECTION_COMPLETE_IND status = %x\r\n", ind->status);
...
static void BleWifi_Ble_CmMsgHandler_SignalUpdateReq(TASK task, MESSAGEID id, MESSAGE message)
{
    ...
    BLEWIFI_INFO("APP-LE_CM_MSG_SIG_CONN_UPDATE_REQ identifier = %d\r\n", req->identifier);
