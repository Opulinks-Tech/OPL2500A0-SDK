...
enum wpa_cipher_type{
    WPA_CIPHER_TYPE_NONE = 0,   /**< the cipher type is none */
    WPA_CIPHER_TYPE_WEP40,      /**< the cipher type is WEP40 */
    WPA_CIPHER_TYPE_WEP104,     /**< the cipher type is WEP104 */
    WPA_CIPHER_TYPE_TKIP,       /**< the cipher type is TKIP */
    WPA_CIPHER_TYPE_CCMP,       /**< the cipher type is CCMP */
    WPA_CIPHER_TYPE_TKIP_CCMP,  /**< the cipher type is TKIP and CCMP */
    WPA_CIPHER_TYPE_AES_CMAC128,/**< the cipher type is AES-CMAC-128 */
    WPA_CIPHER_TYPE_UNKNOWN,    /**< the cipher type is unknown */
};
...
enum wpa_states wpa_sm_get_state(struct wpa_sm *sm);
