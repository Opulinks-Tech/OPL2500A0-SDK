...
static void BleCmMsgHandler(TASK task, MESSAGEID id, MESSAGE message)
{
    ...
    switch (id)
    {
        case LE_CM_MSG_INIT_COMPLETE_CFM:
        {
            ...
            LeGapSetScanRspData(sizeof(gBleScanRspData), gBleScanRspData);
        ...
        case LE_CM_MSG_SIG_CONN_UPDATE_REQ:
        {
            ...
            if (peer) LeGapSigConnUpdateResponse(req->conn_hdl, req->identifier, TRUE);
        }
        break;
        ...
        case LE_CM_MSG_CONN_PARA_REQ:
        {
            ...
            if (peer) LeGapConnParamResponse(req->conn_hdl, TRUE);
        }
        break;
