...
{
#if 0
    // enable all tracer log
    tracer_log_mode_set(TRACER_MODE_NORMAL);
    tracer_log_level_set(TRACER_TASK_IDX_MAX, LOG_ALL_LEVEL);
#endif

    wts_dut_main_init();

    wts_dut_task_send_msg(WTS_DUT_INIT_CMD, 0, NULL);
}
