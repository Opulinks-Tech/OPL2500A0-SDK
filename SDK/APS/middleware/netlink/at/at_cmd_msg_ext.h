 ...
 *
 */
//typedef void (*at_msg_ext_wifi_scan_fp_t)(int cusType, ctrl_wifi_scan_report_t *result);
 ...
 *
 */
typedef void (*at_msg_ext_wifi_scan_sorting_fp_t)(uint8_t num, wifi_scan_info_t *data);

/**
 * @brief Function Pointer Type for API scan by option
 *
 */
typedef void (*at_msg_ext_wifi_scan_by_option_fp_t)(uint8_t num, wifi_scan_info_t *scan_list);
