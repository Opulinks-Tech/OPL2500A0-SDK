...
#define IEEE80211_HT_CAP_LEN                    26
#define IEEE80211_HT_OP_LEN                     22
#define IEEE80211_WMM_IE_LEN                    7
#define IEEE80211_WMM_PARAM_LEN                 24
#define IEEE80211_WMM_TSPEC_LEN                 61
...
#define WLAN_TID_6                  6
#define WLAN_TID_7                  7
#define WLAN_TID_NUM                8
#define WLAN_TID_NUM_MIN            WLAN_TID_0
#define WLAN_TID_NUM_MAX            WLAN_TID_7
...
typedef struct {
    ...
    UINT8   u8EOSP:1;
    UINT8   u8AckPolicy:2;
    UINT8   u8AMSDUPresent:1;
    struct  AP_PS_BUFF_STATE {
        UINT8   u8Reserved:1;
        UINT8   u8BuffStaInd:1;
        UINT8   u8HighPrioBuffAC:2;
        UINT8   u8QosApBuffLoad:4;
    } sApPsBuffState;
} S_WLAN_MHDR_QOS_CTRL;
#define WLAN_MHDR_QOS_CTRL_LEN          sizeof(S_WLAN_MHDR_QOS_CTRL)
