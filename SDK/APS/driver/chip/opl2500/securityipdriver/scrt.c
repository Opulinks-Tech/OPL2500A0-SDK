...
// internal
nl_scrt_common_fp_t scrt_param_init = scrt_param_init_impl;
nl_scrt_common_fp_t scrt_mb_init = scrt_mb_init_impl;
scrt_cmd_fp_t scrt_trng_init = scrt_trng_init_impl;
scrt_cmd_fp_t scrt_eng_init = scrt_eng_init_impl;
scrt_status_chk_fp_t scrt_status_chk = scrt_status_chk_impl;
scrt_asset_create_fp_t scrt_ecdh_key_param_init = scrt_ecdh_key_param_init_impl;
scrt_asset_create_fp_t scrt_ecdh_priv_key_asset_create = scrt_ecdh_priv_key_asset_create_impl;
scrt_asset_create_fp_t scrt_ecdh_pub_key_asset_create = scrt_ecdh_pub_key_asset_create_impl;
scrt_asset_create_fp_t scrt_ecdh_shared_secret_asset_create = scrt_ecdh_shared_secret_asset_create_impl;
scrt_asset_delete_fp_t scrt_asset_delete = scrt_asset_delete_impl;
scrt_asset_load_fp_t scrt_asset_load = scrt_asset_load_impl;
scrt_asset_get_fp_t scrt_asset_get = scrt_asset_get_impl;
//scrt_cmd_fp_t scrt_reset = scrt_reset_impl;
//nl_scrt_common_fp_t scrt_internal_reset = scrt_internal_reset_impl;
scrt_cmd_fp_t scrt_link = scrt_link_impl;

#ifdef SCRT_ENABLE_UNLINK
scrt_cmd_fp_t scrt_unlink = scrt_unlink_impl;
#endif

#ifdef SCRT_ACCESS_SEM
nl_scrt_common_fp_t scrt_access_lock = scrt_access_lock_impl;
nl_scrt_common_fp_t scrt_access_unlock = scrt_access_unlock_impl;
#endif

nl_scrt_common_fp_t scrt_res_lock = scrt_res_lock_impl;
nl_scrt_common_fp_t scrt_res_unlock = scrt_res_unlock_impl;
nl_scrt_common_fp_t scrt_ecdh_lock = scrt_ecdh_lock_impl;
nl_scrt_common_fp_t scrt_ecdh_unlock = scrt_ecdh_unlock_impl;
nl_scrt_common_fp_t scrt_sem_create = scrt_sem_create_impl;
scrt_res_alloc_fp_t scrt_res_alloc = scrt_res_alloc_impl;
scrt_res_free_fp_t scrt_res_free = scrt_res_free_impl;
scrt_clk_enable_fp_t scrt_clk_enable = scrt_clk_enable_impl;

// external
nl_scrt_common_fp_t nl_scrt_Init = nl_scrt_init_impl;
nl_aes_ccm_fp_t nl_aes_ccm = nl_aes_ccm_impl;
nl_scrt_aes_ccm_fp_t nl_scrt_aes_ccm = nl_scrt_aes_ccm_impl;
nl_hmac_sha_1_fp_t nl_hmac_sha_1 = nl_hmac_sha_1_impl;
nl_scrt_aes_ecb_fp_t nl_scrt_aes_ecb = nl_scrt_aes_ecb_impl;
nl_scrt_common_fp_t nl_scrt_otp_status_get = nl_scrt_otp_status_get_impl;
nl_scrt_ecdh_key_pair_gen_fp_t nl_scrt_ecdh_key_pair_gen = nl_scrt_ecdh_key_pair_gen_impl;
nl_scrt_ecdh_dhkey_gen_fp_t nl_scrt_ecdh_dhkey_gen = nl_scrt_ecdh_dhkey_gen_impl;
nl_scrt_key_delete_fp_t nl_scrt_key_delete = nl_scrt_key_delete_impl;
nl_scrt_aes_cmac_fp_t nl_scrt_aes_cmac = nl_scrt_aes_cmac_impl;
//nl_scrt_hmac_sha_1_step_fp_t nl_scrt_hmac_sha_1_step = nl_scrt_hmac_sha_1_step_impl;
nl_scrt_sha_fp_t nl_scrt_sha = nl_scrt_sha_impl;
...
// reserve SCRT_MB_IDX_0/SCRT_MB_IDX_1 for MSQ usage
uint8_t g_u8ScrtMbIdxStart = SCRT_MB_IDX_2;
...
int scrt_asset_get_impl(uint8_t u8Idx, uint32_t u32AsId, uint8_t *u8aBuf, uint32_t u32BufLen, uint32_t u32OutputLen)
{
    ...
    u32aBase[0] = 0x47000000 | u16TokenId;
    u32aBase[1] = SCRT_ID;
    u32aBase[2] = u32AsId;
...
void scrt_clk_enable_impl(uint8_t u8Enable, uint32_t u32Msk)
{
    ...
    {
        Hal_Sys_ApsModuleClkEn(u8Enable, APS_CLK_SCRT);
    }

    if(u32Msk & SCRT_OTP_CLK_MSK)
    {
        Hal_Sys_ApsModuleClkEn(u8Enable, APS_CLK_OTP);
    }
...
uint8_t scrt_res_alloc_impl(void)
{
    ...
    for(i = g_u8ScrtMbIdxStart; i < SCRT_MB_IDX_MAX; i++)
    {
