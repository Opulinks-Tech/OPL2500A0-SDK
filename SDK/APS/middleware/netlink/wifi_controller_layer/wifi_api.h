...
/**
  * @brief     Set configuration of OPL2500 STA
  *
  ...
  * @attention 3. OPL2500 is limited to working on one channel.
...
/**
  ...
  *         - Compatible with OPL1000 series.
  * @return    0  : success
  * @return    other : failed
  */
int wifi_start(void);
...
/**
  * @brief  (Deprecated) Stop wifi working
...
/**
  ...
  *         When receive the disconnect event with reascon code (255), means the something wrong in OPL2500.
...
/**
  ...
  * @param[in] block: (Not Supported) if block is true, this API blocks the caller until scan operation is done, otherwise it returns immediately
  *
  * @return    0  : success
  * @return    other : failed
  */
...
/**
  * @brief     (Deprecated) Get list of APs that found in last scan operation
  *
...
/**
  * @brief     Get information of AP which OPL2500 station is associated with
  *
...
/**
  * @brief Disconnect the link between OPL2500 and connected AP.
  *
  * @return    0  : success
  * @return    other : failed
  */
...
/**
  * @brief (Not Supported) Disconnect the link between the current device and the station.
  *
...
/**
  * @brief     Connect OPL2500 Wi-Fi station to certain AP.
  *
  * @attention 1. This API only impact WIFI_MODE_STA or WIFI_MODE_AP mode
  * @attention 2. If OPL2500 is connected to an AP, call wifi_disconnect to disconnect.
...
/**
  * @brief     (Deprecated) Connect OPL2500 Wi-Fi station to certain AP.
  *
  * @attention
  * @attention
  * @param[in]
...
/**
  * @brief     Connect OPL2500 Wi-Fi station to certain AP in auto connect list.
  *
  * @attention 1. This API only impact WIFI_MODE_STA or WIFI_MODE_AP mode
  * @attention 2. If OPL2500 is connected to an AP, call wifi_disconnect to disconnect.
  *
...
/**
  * @brief     Connect OPL2500 Wi-Fi station to certain AP by auto connect index.
  *
  * @attention 1. This API only impact WIFI_MODE_STA or WIFI_MODE_AP mode
  * @attention 2. If OPL2500 is connected to an AP, call wifi_disconnect to disconnect.
...
/**
  * @brief     Get the signal strength of the connected AP. It's only used
  *            while the station is connected to the AP.
  *
...
/**
  * @brief (Not Supported) register wifi call back handler
  *
...
/**
  * @brief (Not Supported) unregister wifi call back handler
  *
...
/**
  * @brief     Set MAC address of OPL2500 Wi-Fi station or the soft-AP interface.
  *
  * @attention 1. This API can only be called when the interface is disabled
  * @attention 2. OPL2500 soft-AP and station have different MAC addresses, do not set them to be the same.
  *
  * @param[in]  interface: Configure the current wifi working mode,The options are
  *              - WIFI_MODE_STA
  *              - WIFI_MODE_AP (currently not support)
...
/**
  * @brief (Not Supported) Set the ssid value of the current device
  *
  * @param[in] interface: Configure the current wifi working mode,The options are
  *              - WIFI_MODE_STA
  *              - WIFI_MODE_AP (currently not support)
...
/**
  * @brief (Deprecated) get bssid after scan
  *
...
/**
  * @brief  (Deprecated) config OPL2500 Wi-Fi bssid.
  *
...
/**
  * @brief     Get the primary/secondary channel of OPL2500
  *
...
/**
  * @brief     (Not Supported) Set primary/secondary channel of OPL2500
  *
...
/**
  * @brief     (Not Supported) Set the bandwidth of OPL2500 specified interface
  *
  * @param[in]  interface: Configure the current wifi working mode,The options are
  *              - WIFI_MODE_STA
  *              - WIFI_MODE_AP (currently not support)
...
/**
  * @brief     Get the bandwidth of OPL2500 specified interface
  *
...
/**
  * @brief     Get the Skip DTIM value in current wifi setting of OPL2500
  *
...
/**
  * @brief     Set the Skip DTIM value of OPL2500
  *
...
/**
  * @brief     Get the Mac tx data rate in current wifi setting of OPL2500
  *
...
/**
  * @brief     Set the Mac tx data rate setting of OPL2500
  *
...
/**
  * @brief     Get the power saving mode.
  *
  * @param[out]  ps_mode:
  *              - WIFI_PS_NONE
  *              - WIFI_PS_LIGHT
  ...
  *
 */
int wifi_config_get_ps(wifi_ps_mode_t *ps_mode);
...
/**
  ...
  *
 */
int wifi_config_set_ps(wifi_ps_mode_t ps_mode);
...
/**
  * @brief     Clear the AP information which index in the auto connect list.
  *
...
/**
  * @brief     (Deprecated) Get the fast connect mode.
  *
...
/**
  * @brief     (Deprecated) Set the fast connect mode.
  *
...
/**
  * @brief     (Deprecated) Start fast connect mechanism.
  *
