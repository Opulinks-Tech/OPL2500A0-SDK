...
#elif defined(GROUP_COMMON)
    #pragma arm section rwdata="group_common", zidata="group_common"
#elif defined(GROUP_USER_TASK)
    #pragma arm section rwdata="group_user_task", zidata="group_user_task"
