...
T_MwFimFlashCtrlCfg g_MwFim_FlashCtrlCfg;

T_MwFim_FlashLayoutUpdate_Fp MwFim_FlashLayoutUpdate = NULL;


// Sec 5: declaration of global function prototype
T_MwFim_Init_Fp MwFim_Init = MwFim_Init_impl;
T_MwFim_FileRead_Fp MwFim_FileRead = MwFim_FileRead_impl;
T_MwFim_FileWrite_Fp MwFim_FileWrite = MwFim_FileWrite_impl;
T_MwFim_FileWriteDefault_Fp MwFim_FileWriteDefault = MwFim_FileWriteDefault_impl;
T_MwFim_FileDelete_Fp MwFim_FileDelete = MwFim_FileDelete_impl;

T_MwFim_ZoneInfoUpdate_Fp MwFim_ZoneInfoUpdate = MwFim_ZoneInfoUpdate_impl;
T_MwFim_GroupInfoUpdate_Fp MwFim_GroupInfoUpdate = MwFim_GroupInfoUpdate_impl;
T_MwFim_GroupVersionUpdate_Fp MwFim_GroupVersionUpdate = MwFim_GroupVersionUpdate_impl;
...
uint8_t MwFim_GroupBlockDrop_impl(uint32_t ulStartAddr);
void MwFim_Dummy(void);
/***************************************************
Declaration of static Global Variables & Functions
***************************************************/
// Sec 6: declaration of static global variable
uint8_t g_ubMwFimInit = 0;
uint8_t g_ubMwFimInitMsg = 1;
osSemaphoreId g_tMwFimSemaphoreId = NULL;
T_MwFimGroupStatus g_taMwFimGroupStatusTable[MW_FIM_ZONE_MAX][MW_FIM_GROUP_MAX];


// Sec 7: declaration of static function prototype
T_MwFim_FileWriteDo_Fp MwFim_FileWriteDo = MwFim_FileWriteDo_impl;
T_MwFim_GroupSizeCheck_Fp MwFim_GroupSizeCheck = MwFim_GroupSizeCheck_impl;
T_MwFim_GroupStatusFill_Fp MwFim_GroupStatusFill = MwFim_GroupStatusFill_impl;
T_MwFim_GroupHeaderCheck_Fp MwFim_GroupHeaderCheck = MwFim_GroupHeaderCheck_impl;
T_MwFim_GroupHeaderVerify_Fp MwFim_GroupHeaderVerify = MwFim_GroupHeaderVerify_impl;
T_MwFim_GroupCheckSumVerify_Fp MwFim_GroupCheckSumVerify = MwFim_GroupCheckSumVerify_impl;
T_MwFim_GroupStatusRemap_Fp MwFim_GroupStatusRemap = MwFim_GroupStatusRemap_impl;
T_MwFim_EmptyBlockFind_Fp MwFim_EmptyBlockFind = MwFim_EmptyBlockFind_impl;
T_MwFim_GroupBlockParser_Fp MwFim_GroupBlockParser = MwFim_GroupBlockParser_impl;
T_MwFim_FileHeaderVerify_Fp MwFim_FileHeaderVerify = MwFim_FileHeaderVerify_impl;
T_MwFim_FreeOffsetVerify_Fp MwFim_FreeOffsetVerify = MwFim_FreeOffsetVerify_impl;
T_MwFim_FileTableSearch_Fp MwFim_FileTableSearch = MwFim_FileTableSearch_impl;
T_MwFim_GroupSwap_Fp MwFim_GroupSwap = MwFim_GroupSwap_impl;
T_MwFim_GroupBlockErase_Fp MwFim_GroupBlockErase = MwFim_GroupBlockErase_impl;
T_MwFim_GroupBlockDrop_Fp MwFim_GroupBlockDrop = MwFim_GroupBlockDrop_impl;
T_MwFim_FileSizeGet MwFim_FileSizeGet = MwFim_FileSizeGet_impl;
T_MwFim_FileDataDefaultFill_Fp MwFim_FileDataDefaultFill = MwFim_Dummy;
...
void MwFim_Init_impl(E_SpiIdx_t eSpiIdx, E_SpiSlave_t eSlvIdx)
{
    ...
    // 1. before init
    g_ubMwFimInit = 0;
    g_MwFim_FlashCtrlCfg.eSpiIdx = eSpiIdx;
    g_MwFim_FlashCtrlCfg.eSlvIdx = eSlvIdx;
    
    if (g_ubMwFimInitMsg)
        printf("FIM:");
    
    if (MwFim_MsqFimInit() != RESULT_SUCCESS)
    {
        if (g_ubMwFimInitMsg)
            printf("X-MSQ\n");
        return;
    ...
    if (SUPPORTED_FLASH != Hal_Flash_Check_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx))
    {
        if (g_ubMwFimInitMsg)
            printf("X-flash\n");
        return;
    ...
    if (MwFim_InitSemaphore() == MW_FIM_FAIL)
    {
        return;
    }
...
uint8_t MwFim_FileRead_impl(uint32_t ulFileId, uint16_t uwRecIdx, uint16_t uwFileSize, uint8_t *pubFileData)
{
    ...
    // read the file data from flash
    if (0 != Hal_Flash_AddrRead_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ptFileTable->pulDataAddr[uwRecIdx], 0, uwFileSize, pubFileData))
    {
        //printf("FIM: #01\n");
        goto done;
    }
...
uint8_t MwFim_FileWriteDo_impl(uint32_t ulFileId, uint16_t uwRecIdx, uint16_t uwFileSize, uint8_t *pubFileData)
{
    ...
    else
    {
        ...
        // write the file data
        if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulFreeAddr + sizeof(T_MwFimFileHeader), 0, uwFileSize, pubFileData))
        {
            //printf("FIM: #02\n");
            goto done;
        }
        ...
        if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulFreeAddr, 0, sizeof(T_MwFimFileHeader), (uint8_t*)&tFileHeader))
        {
            //printf("FIM: #03\n");
            goto done;
        }
...
void MwFim_GroupHeaderCheck_impl(uint32_t ulZoneIdx, uint8_t ubaBlockUsed[MW_FIM_GROUP_MAX])
{
    ...
    for (ulBlockIdx=0; ulBlockIdx<g_taMwFimZoneInfoTable[ulZoneIdx].ulBlockNum; ulBlockIdx++)
    {
        ...
        if (0 != Hal_Flash_AddrRead_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr, 0, sizeof(T_MwFimGroupHeader), (uint8_t*)&tGroupHeader))
        {
            //printf("FIM: #04\n");
            continue;
        }
        ...
        {
            // drop the block
            if (MW_FIM_OK != MwFim_GroupBlockDrop(ulBlockAddr))
            {
                //printf("FIM: #05\n");
            }
            continue;
        ...
        else
        {
                ...
                && (g_taMwFimGroupStatusTable[ulZoneIdx][tGroupHeader.ubGroupIdx].ubMinorVersion == MW_FIM_VER_GROUP_SEQUENCE_MAX))
            {
                ...
                if (MW_FIM_OK != MwFim_GroupBlockDrop(g_taMwFimZoneInfoTable[ulZoneIdx].ulBaseAddr + g_taMwFimZoneInfoTable[ulZoneIdx].ulBlockSize * ulOldIdx))
                {
                    //printf("FIM: #06\n");
                }
        ...
        if (g_taMwFimGroupStatusTable[ulZoneIdx][ulGroupIdx].ubBlockIdx == 0xFF)
        {
            if (MW_FIM_OK == MwFim_EmptyBlockFind(ulZoneIdx, ubaBlockUsed, &ulEmptyIdx))
            {
                ...
                if (ulGroupIdx != 0)
                {
                    ...
                    MwFim_GroupBlockErase(ulBlockAddr, g_taMwFimZoneInfoTable[ulZoneIdx].ulBlockSize);
                    ...
                    if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr, 0, sizeof(T_MwFimGroupHeader), (uint8_t*)&tGroupHeader))
                    {
                        //printf("FIM: #10\n");
                    }
                }
...
void MwFim_GroupBlockParser_impl(void)
{
    ...
    for (ulZoneIdx=0; ulZoneIdx<MW_FIM_ZONE_MAX; ulZoneIdx++)
    {
        ...
        for (ulGroupIdx=1; ulGroupIdx<g_taMwFimZoneInfoTable[ulZoneIdx].ulBlockNum; ulGroupIdx++)
        {
            ...
            while (0 == Hal_Flash_AddrRead_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr + ulDataOffset, 0, sizeof(T_MwFimFileHeader), (uint8_t*)&tFileHeader))
            {
...
uint32_t MwFim_FreeOffsetVerify_impl(uint32_t ulZoneIdx, uint32_t ulGroupIdx, uint32_t ulDataOffset)
{
    ...
    if (0 != Hal_Flash_AddrRead_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr + ulDataOffset, 0, ulBufferSize, ubaBuffer))
    {
        //printf("FIM: #14\n");
        goto done;
    }
...
uint8_t MwFim_GroupSwap_impl(uint32_t ulZoneIdx, uint32_t ulGroupIdx, T_MwFimFileData *ptReplaceData)
{
    ...
    // erase the block. Erase block when needs swap
    ...
    while ((ptFileTable[i].ulFileId & 0xFFFF0000) == ulPrefix)
    {
        for (j=0; j<ptFileTable[i].uwRecordMax; j++)
        {
            ...
            if (ptFileTable[i].pulDataAddr[j] != MW_FIM_SWAP_DATA_DELETE)
            {
                ...
                if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr + ulFreeOffset, 0, sizeof(T_MwFimFileHeader), (uint8_t*)&tFileHeader))
                {
                    //printf("FIM: #17\n");
                    goto done;
                }
                ...
                if (ptFileTable[i].pulDataAddr[j] == MW_FIM_SWAP_DATA_REPLACE)
                {
                    if (ptReplaceData->pubFileData != NULL)
                    {
                        ...
                        if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr + ulFreeOffset, 0, ptFileTable[i].uwDataSize, ptReplaceData->pubFileData))
                        {
                            //printf("FIM: #19\n");
                            goto done;
                        }
                ...
                else
                {
                    ...
                    while (ulDataSize > 0)
                    {
                        ...
                        if (0 != Hal_Flash_AddrRead_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ptFileTable[i].pulDataAddr[j] + ulDataOffset, 0, ulDataHandleSize, ubaDataBuffer))
                        {
                            //printf("FIM: #18\n");
                            goto done;
                        }
                        ...
                        // write into the target block
                        if (0 != Hal_Flash_AddrProgram_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulBlockAddr + ulFreeOffset + ulDataOffset, 0, ulDataHandleSize, ubaDataBuffer))
                        {
                            //printf("FIM: #19\n");
                            goto done;
                        }
...
uint8_t MwFim_GroupBlockErase_impl(uint32_t ulStartAddr, uint32_t ulGroupSize)
{
    ...
    while (ulRestSize > 0)
    {
        if (0 != Hal_Flash_4KSectorAddrErase_Ext(g_MwFim_FlashCtrlCfg.eSpiIdx, g_MwFim_FlashCtrlCfg.eSlvIdx, ulCurrentAddr))
            goto done;
...
uint16_t MwFim_FileSizeGet_impl(uint32_t ulFileId)
{
    uint32_t ulZoneIdx;
    uint32_t ulGroupIdx;
    uint32_t u32GrpIdMsk;
    T_MwFimFileInfo *ptFileInfo;

    u32GrpIdMsk = ulFileId & MW_FIM_FILEID_GRP_MSK;
    // get the zone and group index
    ulZoneIdx = (ulFileId >> 24) & 0xFF;
    ulGroupIdx = (ulFileId >> 16) & 0xFF;
    
    if ((ulZoneIdx >= MW_FIM_ZONE_MAX) || (ulGroupIdx >= MW_FIM_GROUP_MAX))
        return 0;
    
    ptFileInfo = g_ptaMwFimGroupInfoTable[ulZoneIdx][ulGroupIdx];
    while (ptFileInfo->ulFileId != 0xFFFFFFFF)
    {
        if (ptFileInfo->ulFileId == ulFileId)
            return ptFileInfo->uwDataSize;
        
        if ((ptFileInfo->ulFileId & MW_FIM_FILEID_GRP_MSK) != u32GrpIdMsk)
            break;
