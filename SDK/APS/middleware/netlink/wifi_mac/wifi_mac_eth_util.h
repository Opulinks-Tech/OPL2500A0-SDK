...
int wifi_eth_encap_impl(u8* mpdu_start_ptr, u8* eth_start_ptr, u32 eth_rx_len, void *pEntry);
int ieee80211_put_snap_impl(u8 *data, u16 h_proto);

/* Rom patch interface */
typedef int (*wifi_mpdu_eth_send_fp_t)(void* mpdu,  u8* eth_start_ptr);
typedef int (*wifi_eth_encap_fp_t)(u8* mpdu_start_ptr, u8* eth_start_ptr, u32 eth_rx_len, void *pEntry);
