...
struct wpa_sm *  wpa_sm_init(char * payload, WPA_SEND_FUNC snd_func, \
...
int wpa_set_bss(struct wpa_supplicant *wpa_s, char *macddr, char * bssid, u8 *ssid, size_t ssid_len, struct wpa_ie_data *data);
