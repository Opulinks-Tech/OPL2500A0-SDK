...
RET_DATA uint32_t gLeHostNvmStore4[MW_FIM_LE_STORE4_NUM];
RET_DATA uint32_t gLeHostNvmStore5[MW_FIM_LE_STORE5_NUM];
...
const T_MwFimFileInfo g_taMwFimGroupTable04[] =
{
    ...
    {MW_FIM_IDX_LE_STORE4, MW_FIM_LE_STORE4_NUM, MW_FIM_LE_STORE3_SIZE, NULL, gLeHostNvmStore4},
    {MW_FIM_IDX_LE_STORE4, MW_FIM_LE_STORE5_NUM, MW_FIM_LE_STORE5_SIZE, NULL, gLeHostNvmStore5},
