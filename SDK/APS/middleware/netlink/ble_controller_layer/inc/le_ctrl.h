...
typedef int (*t_le_ctrl_util_gen_random_range_fp)(int min, int max);
typedef uint32_t (*t_le_ctrl_util_number_of_set_bits_fp)(uint32_t i);
typedef void (*t_le_ctrl_afh_bad_channel_sort_fp)(le_channel_record_t rec[], int len);
typedef void (*t_le_ctrl_afh_blacklist_push_fp)(uint8_t ch);
typedef void (*t_le_ctrl_afh_blacklist_pop_fp)(uint8_t idx);
typedef uint8_t (*t_le_ctrl_afh_blacklist_size_get_fp)(void);
typedef void (*t_le_ctrl_afh_blacklist_print_fp)(void);
typedef void (*t_le_ctrl_afh_channelmap_decide_fp)(le_channel_record_t rec[]);
// le_ctrl_enc
...
typedef void (*t_send_vendor_specific_set_afh_command_fp)(uint8_t enable, uint8_t interval, uint8_t dbg_le_info_en);
...
typedef void (*t_vendor_specific_afh_channel_condition_event_handler_fp)(hci_event_packet_04 *event_packet);
typedef void (*t_vendor_specific_afh_channel_condition_event_handler_fp)(hci_event_packet_04 *event_packet);
// le_ctrl_fim
...
extern t_le_ctrl_util_gen_random_range_fp le_ctrl_util_gen_random_range;
extern t_le_ctrl_util_number_of_set_bits_fp le_ctrl_util_number_of_set_bits;
extern t_le_ctrl_afh_bad_channel_sort_fp le_ctrl_afh_bad_channel_sort;
extern t_le_ctrl_afh_blacklist_push_fp le_ctrl_afh_blacklist_push;
extern t_le_ctrl_afh_blacklist_pop_fp le_ctrl_afh_blacklist_pop;
extern t_le_ctrl_afh_blacklist_size_get_fp le_ctrl_afh_blacklist_size_get;
extern t_le_ctrl_afh_blacklist_print_fp le_ctrl_afh_blacklist_print;
extern t_le_ctrl_afh_channelmap_decide_fp le_ctrl_afh_channelmap_decide;
// le_ctrl_enc
...
extern t_send_vendor_specific_set_afh_command_fp send_vendor_specific_set_afh_command;
...
extern t_vendor_specific_afh_channel_condition_event_handler_fp vendor_specific_afh_channel_condition_event_handler;
// le_ctrl_fim
...
// le_ctrl_hci_uart_tl (Uart Transport Layer)
void le_ctrl_hci_uart_input_impl(uint32_t data);
// le_ctrl_data (Data Manipulation)
...
void le_ctrl_pkt_ctr_increment_impl(packet_counter_t *ctr);
    /***** AFH related *****/
int le_ctrl_util_gen_random_range_impl(int min, int max);
uint32_t le_ctrl_util_number_of_set_bits_impl(uint32_t i);
void le_ctrl_afh_bad_channel_sort_impl(le_channel_record_t rec[], int len);
void le_ctrl_afh_blacklist_push_impl(uint8_t ch);
void le_ctrl_afh_blacklist_pop_impl(uint8_t idx);
uint8_t le_ctrl_afh_blacklist_size_get_impl(void);
void le_ctrl_afh_blacklist_print_impl(void);
void le_ctrl_afh_channelmap_decide_impl(le_channel_record_t rec[]);
// le_ctrl_enc
...
// le_ctrl_hci_handler (HCI Handler)
...
void send_vendor_specific_set_afh_command_impl(uint8_t enable, uint8_t interval, uint8_t dbg_le_info_en);
...
void vendor_specific_afh_channel_condition_event_handler_impl(hci_event_packet_04 *event_packet);
// le_ctrl_fim (MwFim related)
