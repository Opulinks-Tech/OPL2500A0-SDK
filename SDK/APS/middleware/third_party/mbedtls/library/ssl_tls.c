...
#define MBEDTLS_SSL_MAX_CONTENT_LEN_VALUE       16384   /**< Size of the input / output buffer */

int mbedtls_ssl_max_content_len = (6*1024);
int mbedtls_ssl_in_content_len  = (6*1024);
int mbedtls_ssl_out_content_len = (6*1024);
...
{
    if (max_content_len > MBEDTLS_SSL_MAX_CONTENT_LEN_VALUE)
        max_content_len = MBEDTLS_SSL_MAX_CONTENT_LEN_VALUE;

    mbedtls_ssl_max_content_len = max_content_len;
    mbedtls_ssl_in_content_len  = max_content_len;
    mbedtls_ssl_out_content_len = max_content_len;
}

void mbedtls_ssl_set_in_content_len(int in_content_len)
{
    mbedtls_ssl_in_content_len = in_content_len;

    if (mbedtls_ssl_in_content_len > mbedtls_ssl_max_content_len)
        mbedtls_ssl_in_content_len = mbedtls_ssl_max_content_len;
}

void mbedtls_ssl_set_out_content_len(int out_content_len)
{
    mbedtls_ssl_out_content_len = out_content_len;

    if (mbedtls_ssl_out_content_len > mbedtls_ssl_max_content_len)
        mbedtls_ssl_out_content_len = mbedtls_ssl_max_content_len;
}
