...
#define LE_HCI_ADV_EVT_MASK_CONNECTABLE				(0x0001)
#define LE_HCI_ADV_EVT_MASK_SCANNABLE				(0x0002)
#define LE_HCI_ADV_EVT_MASK_DIRECT					(0x0004)
#define LE_HCI_ADV_EVT_MASK_DIRECT_HD				(0x0008)
#define LE_HCI_ADV_EVT_MASK_LEGACY					(0x0010)
#define LE_HCI_ADV_EVT_MASK_ANONYMOUS				(0x0020)
#define LE_HCI_ADV_EVT_MASK_TX_POWER				(0x0040)

// Advertising Report Event type
#define LE_HCI_ADV_REPORT_MASK_CONNECTABLE			(0x0001)
#define LE_HCI_ADV_REPORT_MASK_SCANNABLE			(0x0002)
#define LE_HCI_ADV_REPORT_MASK_DIRECT				(0x0004)
#define LE_HCI_ADV_REPORT_MASK_SCAN_RSP				(0x0008)
#define LE_HCI_ADV_REPORT_MASK_LEGACY				(0x0010)
...
// Peer address types
#define LE_HCI_PEER_ADDR_PUBLIC        				(0)
#define LE_HCI_PEER_ADDR_RANDOM        				(1)
#define LE_HCI_PEER_ADDR_PUB_ID       				(2)
#define LE_HCI_PEER_ADDR_RAND_ID      				(3)
...
// Scan filter
#define LE_HCI_SCAN_DUPLICATE_DISABLE      			(0)
#define LE_HCI_SCAN_DUPLICATE_ENABLE      			(1)
#define LE_HCI_SCAN_DUPLICATE_PERIOD      			(2)
...
// SYNC Datat Status
#define	LE_HCI_SYNC_DATA_COMPLETE					0
#define	LE_HCI_SYNC_DATA_INCOMPLETE_MORE			1
#define	LE_HCI_SYNC_DATA_INCOMPLETE_TRUNCATED		2
