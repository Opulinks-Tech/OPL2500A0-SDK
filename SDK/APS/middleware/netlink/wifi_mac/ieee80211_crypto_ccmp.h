...
u8* ccmp_decrypt_mgmt_impl(const u8 *tk, const u8 *hdr, u8 *data, size_t data_len, size_t *decrypted_len);
u8* ccmp_encrypt_mgmt_impl(const u8 *tk, u8 *frame, size_t len, size_t hdrlen, u8 *pn, int keyid, size_t *encrypted_len);
...
typedef u8* (*ccmp_decrypt_mgmt_fp_t)(const u8 *tk, const u8 *hdr, u8 *data, size_t data_len, size_t *decrypted_len);
typedef u8* (*ccmp_encrypt_mgmt_fp_t)(const u8 *tk, u8 *frame, size_t len, size_t hdrlen, u8 *pn, int keyid, size_t *encrypted_len);
